 ...
 * otherwise.
 */
i32 lfm_mode_register(struct Lfm *lfm, struct mode *mode);
 ...
 */
i32 lfm_mode_enter(struct Lfm *lfm, zsview name);

/*
 * Enter normal mode.
 */
static inline i32 lfm_mode_normal(struct Lfm *lfm) {
 ...
 */
i32 lfm_mode_exit(struct Lfm *lfm, zsview name);
